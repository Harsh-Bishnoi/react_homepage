                            ...
                            <div className="mx-auto">
                                ...
                                <div className="flex gap-[30px] flex-wrap justify-center xl:max-w-[550px]">
                                    {CARD_DATA.map((item, index) => (
                                        <div key={index} className='max-w-[500px] sm:max-w-[260px] max-sm:px-7 w-full hover:bg-[#2C49FE] border rounded-[5px] group relative border-[#2C49FE] mb-5 transition-all duration-200 ease-linear'>
