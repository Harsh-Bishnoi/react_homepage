                ...
                <div className="max-w-[1320px] px-4 mx-auto">
                    <div className="flex flex-wrap flex-row -mx-3">
                        <div className="px-4 w-full lg:w-[41.66%] mb-6 lg:mb-0">
                            ...
                            <CustomHeading HeadingClass="!leading-[137%] max-w-[388px] pb-3" heading="Explore our latest events" />
                            <CustomDescription discriptionClass="font-family-primary !leading-[140%] max-w-[477px] pb-4 !text-[#000000B2]" text="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc efficitur urna in dictum suscipit. Suspendisse maximus ipsum sem. Donec ut justo et leo congue lacinia vitae nec arcu." />
                            <a className='font-family-primary font-bold text-base leading-[100%] text-black ' href="#">LEARN MORE</a>
                        </div>
                        <div className="px-4 w-full lg:w-[58.33%]">
                            {LOREM_DATA.map((item, index) => (
                                <div key={index} className='max-w-[709px]'>
                                    <div className="max-w-[339px] pt-2.5 pr-[11px] pb-6 pl-[13px] hover:bg-white hover:shadow-lg rounded-[5px]">
